...
similar words were close together, we can embed completely different media - in our case, GIFs and sentences



f we can embed the representations of GIFs and sentences together just like we did words, then just like synonyms for a word may be "nearby" in the word embedding space, GIFs that 
